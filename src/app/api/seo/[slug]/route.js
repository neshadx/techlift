...
const PAGES = {
  ...
  contact: {
    title: "Contact - TechLift",
    description: "Get in touch with the TechLift team for support and inquiries.",
    path: "/contact",
    image: "/og/techlift-og.jpg",
  },
  courses: {
    title: "Courses - TechLift",
    description:
